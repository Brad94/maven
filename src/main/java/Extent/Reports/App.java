...
public class App {
	...
	public void verifyHomePageTitle() {
		...
		report = new ExtentReports(
				"C:\\Users\\Administrator\\Documents\\Eclipse\\Reports\\automationreport.html",
				true);
		// init/start the test
		test = report.startTest("Verify application Title");
		System.setProperty("webdriver.gecko.driver",
				"C:\\Users\\Administrator\\Documents\\Eclipse\\SeleniumFiles\\Selenium\\geckodriver.exe");
	...
	public void verifyLogo() throws IOException {
		...
		if (src == null) {
			...
			FileUtils.copyFile(scrFile, new File(
					"C:\\Users\\Administrator\\Documents\\Eclipse\\SeleniumFiles\\Selenium\\img.jpg"));
